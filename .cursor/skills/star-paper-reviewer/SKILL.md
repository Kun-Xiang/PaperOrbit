...
- The workflow has no mandatory gates — the target resolution may need one plain-text question when the argument is ambiguous; otherwise the skill runs to its report without questions, which is what makes it safe on a timer.
